...
public class SwaggerConfig extends WebMvcConfigurationSupport {
  ...
  public Docket greetingApi() {
    ...
    return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.br.project.ws")).build().apiInfo(metaData()).useDefaultResponseMessages(false)
  ...
  private ApiInfo metaData() {
    ...
    return new ApiInfoBuilder().title("Project APIs").description("Test Spring Boot Project").version("1.0.0").license("Apache License Version 2.0")
